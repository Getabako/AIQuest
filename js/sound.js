...
const SoundSystem = {
  ...
  playBGM: function(name) {
    ...
    var loop = function() {
      ...
      if (name === 'title') {
        ...
        duration = self._playEndingLoop(t);
      }
  ...
  // エンディングBGM - 感動のオルゴール風（C major, 80BPM, 32ビート）
  _playEndingLoop: function(t) {
    var b = 60 / 80; // ゆったり感動的 80BPM

    // メロディ（sine = オルゴール風）
    var melody = [
      // フレーズ1: 優しい始まり
      659, 1,  784, 1,  1047, 2,             // E5 G5 C6~
      988, 1,  880, 1,  784, 2,              // B5 A5 G5~
      // フレーズ2: 語りかけ
      880, 1,  988, 1,  1047, 2,             // A5 B5 C6~
      988, 1,  784, 1,  659, 2,              // B5 G5 E5~
      // フレーズ3: 盛り上がり
      659, 1,  784, 1,  1047, 2,             // E5 G5 C6~
      1175, 1,  1047, 1,  988, 2,            // D6 C6 B5~
      // フレーズ4: 穏やかな着地
      880, 1,  784, 1,  659, 1,  784, 1,     // A5 G5 E5 G5
      523, 3,  0, 1                           // C5~~~ rest
    ];
    ...
    var arp = [
      ...
      220, 0.5,  262, 0.5,  330, 0.5,  262, 0.5,
      // F: F3 A3 C4 A3 (x2)
      175, 0.5,  220, 0.5,  262, 0.5,  220, 0.5,
      175, 0.5,  220, 0.5,  262, 0.5,  220, 0.5,
      // C: C4 E4 G4 E4 (x2)
      262, 0.5,  330, 0.5,  392, 0.5,  330, 0.5,
      262, 0.5,  330, 0.5,  392, 0.5,  330, 0.5,
      ...
      262, 0.5,  330, 0.5,  392, 0.5,  330, 0.5,
      // G: G3 B3 D4 B3 (x2)
      196, 0.5,  247, 0.5,  294, 0.5,  247, 0.5,
      196, 0.5,  247, 0.5,  294, 0.5,  247, 0.5,
      // F
      175, 0.5,  220, 0.5,  262, 0.5,  220, 0.5,
      196, 0.5,  247, 0.5,  294, 0.5,  247, 0.5,
      // C (ending)
      262, 0.5,  330, 0.5,  392, 0.5,  330, 0.5,
      262, 0.5,  330, 0.5,  262, 0.5,  196, 0.5
    ];
    ...
    var dur = this._scheduleSeq(melody, t, b, 'sine', 0.3);
    this._scheduleSeq(arp, t, b, 'sine', 0.1);
    this._scheduleSeq(bass, t, b, 'sine', 0.15);
